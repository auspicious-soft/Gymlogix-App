...
class GymlogixRemote {
  ...
  Future<dynamic> requestPostType({required ApiEndpoints endPoint,required Map<String,dynamic> body}) async {
    final encoded = jsonEncode(body);
    final uri = Uri.parse('$_BASE_URL${endPoint.value}');
    print(uri);
