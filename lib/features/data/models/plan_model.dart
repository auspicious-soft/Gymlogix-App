...
class Exercise {
  ...
  factory Exercise.fromJson(Map<String, dynamic> json) => Exercise(
        ...
        workoutExercises: json["workout_exercises"] == null
            ? []
            : List<WorkoutExercise>.from(json["workout_exercises"]!
                .map((x) => WorkoutExercise.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "workout_exercises": workoutExercises == null
            ? []
            : List<dynamic>.from(workoutExercises!.map((x) => x.toJson())),
      };
}
...
class WorkoutExercise {
  ...
  factory WorkoutExercise.fromJson(Map<String, dynamic> json) =>
      WorkoutExercise(
        ...
        alternateExerciseId: json["alternate_exercise_id"] == null
            ? []
            : List<dynamic>.from(json["alternate_exercise_id"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "alternate_exercise_id": alternateExerciseId == null
            ? []
            : List<dynamic>.from(alternateExerciseId!.map((x) => x)),
      };
}
