...
import 'package:gymlogix/features/base/presentation/screens/createfoodlog/pg_createfoodlog.dart';
import 'package:gymlogix/features/base/presentation/screens/dashboard/pg_dashboard.dart';

class PgLogfoodstart extends StatefulWidget {
  const PgLogfoodstart({super.key});

  @override
  State<PgLogfoodstart> createState() => _PgLogfoodstartState();
}

class _PgLogfoodstartState extends State<PgLogfoodstart> {
  @override
              ...
              commonButton(
                ...
                onPressed: () => {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const PgCreatefoodlog()),
                  ),
                },
              ),
              const SizedBox(
